...
import { Decision, RunStatus, PlaybookFailureCategory } from "./index.ts";
...
export const BoardCard = Schema.Struct({
  ...
  failureCategory: Schema.NullOr(PlaybookFailureCategory),
...
export const TimelineEntry = Schema.Struct({
  ...
  failureCategory: Schema.optional(PlaybookFailureCategory),
