...
export const PlaybookFailureCategory = Schema.Literals([
  "action_failed",
...
export const Action = Schema.Struct({
  ...
  predecessorActionId: Schema.optional(Schema.String),
});
...
export const Run = Schema.Struct({
  ...
  failureCategory: Schema.optional(Schema.NullOr(PlaybookFailureCategory)),
...
export const RunDetail = Schema.Struct({
  ...
  interruptions: Schema.optional(Run.fields.interruptions),
...
export const PlaybookPhasePresentation = Schema.Struct({
  id: Schema.String,
...
export const PlaybookDefinitionImportRequest = Schema.Struct({
  files: Schema.Array(
    Schema.Struct({
...
export const PlaybookDefinitionStateRequest = Schema.Struct({
  id: Schema.String,
