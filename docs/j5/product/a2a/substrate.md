...
Agents and only Peer Agents. Every upstream mechanism is judged by one question: *does it carry an
opinion about agent organization?* Topology-free plumbing is consumed; org-shaped opinion is
