...
**Core verdict at `e041f576` is unaffected** and remains clean (see `reviewer-verdict-core.md`). Everything below is new surface introduced by the integration commit.
