...
> **Currency note (2026-08-31, reserved for dogfood):** anchors cite the A3-era SilenceDetector; re-measure all anchors at your base (the detector has survived several merges unchanged in substance, but verify). The R4 law this implements is stated in `docs/j5/worklog/2026-08-21-design-review.md` and the fact-bundle philosophy now also governs shipped surfaces (e.g. inbox terminal_disposition) — keep vocabularies consistent with `docs/j5/product/a2a/agent-tools.md`.
