...
| Task                            | Command                                           |
| ------------------------------- | ------------------------------------------------- |
| Install and start               | `npx @jacksondr5/j5code@latest service install`   |
| Inspect status and log location | `npx @jacksondr5/j5code@latest service status`    |
| Update or repair                | `npx @jacksondr5/j5code@latest service update`    |
| Stop and remove from startup    | `npx @jacksondr5/j5code@latest service uninstall` |

Uninstalling the service leaves your projects, threads, and settings intact.

Install and update use the version of the CLI you invoke. For nightly, use
`npx @jacksondr5/j5code@nightly service update`; replace `nightly` with an exact version to pin
