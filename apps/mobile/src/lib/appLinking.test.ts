...
describe("shouldHandleAppLink", () => {
  it.each(["j5code://", "j5code:///", "j5code-dev://", "j5code-preview://"])(
  ...
  it.each([
    "j5code://threads/env-1/thread-1",
    "j5code://pair?pairingUrl=x",
    "j5code-dev://settings/usage?tab=limits",
  ])("handles path-bearing URL %s", (url) => {
    expect(shouldHandleAppLink(url)).toBe(true);
  });

  it.each(["j5code://expo-development-client/?url=x", "j5code://expo-sharing/anything"])(
