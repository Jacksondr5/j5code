...
<header>↑ Drag J5 Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag J5 Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">J5 Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged J5 Code icon is missing.");
