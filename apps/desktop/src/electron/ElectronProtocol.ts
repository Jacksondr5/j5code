...
export const DESKTOP_PRODUCTION_SCHEME = J5_BRANDING.desktop.productionScheme;
export const DESKTOP_DEVELOPMENT_SCHEME = J5_BRANDING.desktop.developmentScheme;
