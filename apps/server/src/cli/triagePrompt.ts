/**
 * All text `j5 triage` hands to the coding agent. Kept as bare template strings
...
- How is T3 Code running on this machine: \`npx @jacksondr5/j5code serve\` in a terminal, the
...
having a problem with their install and started this session with \`j5 triage\`.
...
Generated by \`j5 triage\` at ${input.generatedAt}.
