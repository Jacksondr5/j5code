/**
 * All text `j5code triage` hands to the coding agent. Kept as bare template strings
...
- How is T3 Code running on this machine: \`npx j5code serve\` in a terminal, the
...
having a problem with their install and started this session with \`j5code triage\`.
...
Generated by \`j5code triage\` at ${input.generatedAt}.
