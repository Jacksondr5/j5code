...
- Use the project workspace's shared \`artifacts/\` directory for durable, user-consumable planning outputs that should remain available across threads and agents, such as plans, specifications, diagrams, and research notes. Do not use it for source code, build output, logs, temporary scratch files, or ordinary repository documentation. J5 keeps the directory locally ignored by Git and exposes it in the Artifacts panel.
