...
- Store planning documents you create for the user—plans, specifications, diagrams, and research notes—under the project workspace's shared \`artifacts/\` directory. J5 keeps that directory locally ignored by Git and exposes it in the Artifacts panel so every agent in the project can use the same files.
