...
export class A2APeerReceiverNotFoundError extends Schema.TaggedErrorClass<A2APeerReceiverNotFoundError>()(
...
export class A2APeerReceiverNotDeliverableError extends Schema.TaggedErrorClass<A2APeerReceiverNotDeliverableError>()(
...
export class A2APeerAskIntentRequiredError extends Schema.TaggedErrorClass<A2APeerAskIntentRequiredError>()(
