...
export class PeerCredentialRejectedError extends Schema.TaggedErrorClass<PeerCredentialRejectedError>()(
...
export class PeerCredentialMismatchError extends Schema.TaggedErrorClass<PeerCredentialMismatchError>()(
...
export class PeerIsSelfError extends Schema.TaggedErrorClass<PeerIsSelfError>()("PeerIsSelfError", {
