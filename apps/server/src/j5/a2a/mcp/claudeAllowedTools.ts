 ...
 * the allowlist, so without this spread a read-only reviewer on Claude could not
 * message or spawn anything. The J5 handlers enforce persona permissions themselves;
