...
const CrewSeatPersona = AgentPersonaId.annotate({
  description:
    "Persona id from list_personas. Omit for a custom seat with required instructions and optional model_selection/runtime_mode overrides; omitted settings inherit the Captain. Saved personas use their own configuration and do not accept overrides.",
});
