...
it.effect("tracks J5 A2A migrations independently from upstream migrations", () =>
  Effect.gen(function* () {
    ...
    assert.deepStrictEqual(j5, [
      ...
      { migration_id: 19, name: "PeerDeliveryOrigin" },
      { migration_id: 20, name: "PeerDeliveryReceiver" },
      { migration_id: 21, name: "PeerRouteIndexes" },
      { migration_id: 22, name: "PeerSenderLabelIndex" },
    ]);
    assert.deepStrictEqual(
      ...
      [
        ...
        [18, "Peers"],
        [19, "PeerDeliveryOrigin"],
        [20, "PeerDeliveryReceiver"],
        [21, "PeerRouteIndexes"],
        [22, "PeerSenderLabelIndex"],
      ],
    );
