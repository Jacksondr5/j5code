...
import Migration0014 from "./migrations/014_Peers.ts";
import Migration0015 from "./migrations/015_PeerDeliveryOrigin.ts";
import Migration0016 from "./migrations/016_PeerDeliveryReceiver.ts";

export const J5_A2A_MIGRATIONS_TABLE = "j5_a2a_migrations";

// Entries 1 through 16 are persisted migration history. Keep their file and manifest names unchanged;
...
export const migrationEntries = [
  ...
  [14, "Peers", Migration0014],
  [15, "PeerDeliveryOrigin", Migration0015],
  [16, "PeerDeliveryReceiver", Migration0016],
] as const;
