 ...
 * never propose one. Draft state can remember a different pick (the model chosen before `/crew`
 * turned the draft into a Captain), which is exactly the case this collapses back onto the route.
 */
