        ...
        <div className="grid gap-1 text-sm">
          {lastApply.conflicts.length > 0 ? (
            <p role="alert" className="text-destructive-foreground">
              The conflicting paths were left unchanged. Review links before replacing them; they
              may be used by another environment. Existing files or folders must be moved manually.
            </p>
          ) : null}
