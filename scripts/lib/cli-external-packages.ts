...
export const CLI_RUNTIME_EXTERNAL_PREFIXES = [
  // Ships macOS and Windows trash helpers resolved beside the package at runtime. Its complete
  // dependency closure stays external because the staged server loads trash from node_modules.
  "trash",
  "@stroncium/procfs",
  "chunkify",
  "globby",
